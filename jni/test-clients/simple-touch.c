...
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "simple-touch", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "simple-touch", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "simple-touch", __VA_ARGS__))
...
struct touch {
	...
	struct wl_fullscreen_shell *fullscreen_shell;
	struct wl_shm *shm;
	struct wl_seat *seat;
